...
ABOUT SCRIPT:
It is a script for exporting the features of Bosphorus database images into CSV files as a list of features.
"""
...
from data_bosphorus.utils import feature_exporter

parser = argparse.ArgumentParser(description='Vein Verification')

parser.add_argument('--num-classes', default=50, type=int, metavar='NC',
...
parser.add_argument('--train-val-indir', default='data_bosphorus/CSVFiles/output_list_train_val.csv', type=str,
                    help='path to the CSV input file including the list of train/validation partitions')
parser.add_argument('--test-indir', default='data_bosphorus/CSVFiles/output_list_test.csv', type=str,
                    help='path to the CSV input file including the list of test partition')
parser.add_argument('--train-val-feat_outdir', default='data_bosphorus/CSVFiles/base_feature_list_train_val.csv', type=str,
                    help='path to the CSV output file including the list of train/validation features')
parser.add_argument('--test-feat_outdir', default='data_bosphorus/CSVFiles/base_feature_list_test.csv', type=str,
